...
import { UsersController, OrganizationController, PublicOrgController } from './users.controller';
...
@Module({
  ...
  controllers: [UsersController, OrganizationController, PublicOrgController],
